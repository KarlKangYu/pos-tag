...
class TextCNN(object):
    ...
    def __init__(
      ...
      embedding_size, filter_sizes, filter_sizes2, num_filters, l2_reg_lambda=0.0):
        ...
        self.dropout_keep_prob_1 = tf.placeholder_with_default(1.0, [], name="dropout_keep_prob_1")
        self.dropout_keep_prob_2 = tf.placeholder_with_default(1.0, [], name="dropout_keep_prob_2")
        self.tempreture = tf.placeholder_with_default(1.0, [], name="Tempreture")
